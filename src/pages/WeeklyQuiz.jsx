...
import { wqData } from '../data/weeklyQuiz'
...
export default function WeeklyQuiz() {
  ...
  const question = wqData.questions[currentQuestion]
  const totalQuestions = wqData.totalQuestions
  ...
  const calculateScore = () => {
    let correct = 0
    wqData.questions.forEach((q, idx) => {
        ...
        <div className="max-w-lg w-full mx-auto">
          <div className="bg-white rounded-3xl p-12 shadow-lg border border-slate-100">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-slate-600 mb-6">Great effort on this week's questions.</p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button className="w-full bg-slate-100 text-slate-600 py-4 rounded-xl font-bold hover:bg-slate-200 transition-all flex items-center justify-center gap-2">
  ...
  return (
    <div className="pt-6 px-0 md:px-2 pb-16">
      ...
      <div className="max-w-4xl mx-auto mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-secondary mb-2">{wqData.week}</p>
            <h1 className="font-headline text-4xl md:text-5xl font-bold text-[#060818]">{wqData.title}</h1>
          </div>
          <div className="text-right">
            <p className="text-xs font-bold uppercase tracking-widest text-slate-600 mb-1">Progress</p>
            <p className="font-headline text-3xl font-bold text-secondary">{answered}/{totalQuestions}</p>
          </div>
        </div>
