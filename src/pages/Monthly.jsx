...
export default function Monthly() {
  ...
  const allAnswered = Object.keys(answers).length === moData.totalQuestions
  const percentage = allAnswered ? Math.round((score / moData.totalQuestions) * 100) : 0
    ...
    <div className="pt-6 px-0 md:px-2 pb-16">
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        <p className="text-slate-600 text-lg mb-8">
          Solve all {moData.totalQuestions} questions to complete your monthly revision. Track your progress below.
        </p>
        ...
        {allAnswered && (
          <div className="bg-gradient-to-r from-secondary/10 to-secondary-container/10 rounded-2xl p-6 border border-secondary/20">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-3xl font-bold text-secondary">{score}/{moData.totalQuestions}</span>
            </div>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-3 gap-6 max-w-md mx-auto">
              <div className="bg-white rounded-xl p-4">
                ...
                <p className="font-headline text-2xl font-bold text-[#060818]">{moData.totalQuestions}</p>
              </div>
              <div className="bg-white rounded-xl p-4">
